...
const ProfileHanger: React.FC<ProfileHangerProps> = ({user}) => {
  ...
  const avatarSource =
    user.avatar_uri && user.avatar_uri.length
      ? {uri: DOMAIN + '/' + user.avatar_uri}
      : defaultAvatar;
  ...
  const changeUserType = async () => {
    ...
    const newType =
      user.organization_type === USER_TYPE.INSPECTION
        ? USER_TYPE.SELLER
        : USER_TYPE.INSPECTION;
            ...
            <TouchableWithoutFeedback>
              <View style={styles.modalView}>
                ...
                <View style={styles.modalText}>
                  ...
                  <Text>{`${t('profileHanger.youAre')} ${t(
                    `userType.${user.organization_type}`,
                  )}.`}</Text>
                </View>
              </View>
            </TouchableWithoutFeedback>
            ...
            <TouchableWithoutFeedback>
              <View style={styles.modalView}>
                ...
                <View style={styles.modalText}>
                  ...
                  <SecondaryButton
                    title={t('profileHanger.changeUserType')}
